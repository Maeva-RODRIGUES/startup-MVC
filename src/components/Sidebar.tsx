...
import { getClientIntl } from "@/lib/intl.client";
import { Locale } from "@/lib/definitions";
import { loadMessages } from "@/lib/intlHelpers"; // Importez la fonction externe
...
export default function Sidebar({ locale }: Props) {
  ...
  useEffect(() => {
    loadMessages(locale).then(messages => {
      const intlInstance = getClientIntl(locale, messages);
